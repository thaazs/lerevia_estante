...
-- acaba com o banco
drop  database estante_virtual;

-- Criação do banco de dados
CREATE DATABASE estante_virtual;
USE estante_virtual;
-- Tabela de Usuários
...
-- Tabela de Marcação de Livros
CREATE TABLE marcacao_livros (
...
INSERT INTO livros (titulo, autor, genero, capa_url, pagina_url)
VALUES 
('Branding + design: a estratégia na criação de identidades de marca', 'Sandra Ribeiro Cameira', 'design avançado', 'https://m.media-amazon.com/images/I/81UCmydz24L._UF894,1000_QL80_.jpg', 'livros/design/avancado/brandig+design.html'),
('Design Thinking: uma metodologia poderosa para decretar o fim das velhas ideias', 'Tim Brown', 'design avançado', 'https://m.media-amazon.com/images/I/81JRryNOO8L._AC_UF1000,1000_QL80_.jpg', 'livros/design/avancado/designthinking.html'),
('Leis da Psicologia Aplicadas a UX: Usando psicologia para projetar produtos e serviços melhores', 'Jon Yablonski', 'design avançado', 'https://m.media-amazon.com/images/I/61YhnDlYsXL._AC_UF894,1000_QL80_.jpg', 'livros/design/avancado/leispsicologia.html'),
('Domain-Driven Design: Atacando as Complexidades no coração do Software', 'Eric Evans e Martin Flowler', 'design avançado', 'https://m.media-amazon.com/images/I/81ykBjVaUjL._AC_UF894,1000_QL80_.jpg', 'livros/design/avancado/domainDrivenDesign.html'),
('Design para um mundo complexo', 'Rafael Cardoso e Francisco França', 'design avançado', 'https://m.media-amazon.com/images/I/71QRpK882VL._UF894,1000_QL80_.jpg', 'livros/design/avancado/mundocomplexo.html'),
('Arquitetura limpa: o Guia do artesão para estrutura e design de software', 'Robert C. Martin; Kevlin Henney; Jason Gorman', 'design avançado', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAxgGbmExEs-WkE3Rc7ASI2ADcdj-sYlC86g&s', 'livros/design/avancado/arquiteturalimpa.html'),
('Design como atitude', 'Alice Rawsthorn', 'design avançado', 'https://m.media-amazon.com/images/I/71WKWHwYWPL._AC_UF1000,1000_QL80_.jpg', 'livros/design/avancado/designatitude.html'),
('O design como storytelling', 'Ellen Lupton', 'design avançado', 'https://images.cdn2.buscalibre.com/fit-in/360x360/6f/b8/6fb84c438320e95a54cb102a78f62a2c.jpg', 'livros/design/avancado/designstorytelling.html'),
('Design estratégico', 'Anderson Penha e André Coutinho', 'design avançado', 'https://altabooks.com.br/wp-content/uploads/2021/07/700x1000_DesignEstrategico.png', 'livros/design/avancado/designEstratégico.html'),
('Do design Thinking ao design doing', 'Jon Koldo', 'design avançado', 'https://m.media-amazon.com/images/I/61Z4l2p-YsL._AC_UF1000,1000_QL80_.jpg', 'livros/design/avancado/thinkingDoing.html'),
...
('Conceitos de Linguagens de Programação', 'Robert W. Sebesta', 'Computação', 'https://m.media-amazon.com/images/I/81TtOBkUoqL._SY425_.jpg', 'livros/dev/livros/19.html');
...
-- Mostrar todos lidos do usuario
Select
livros.id,
livros.titulo
from
...
usuarios.id = 1 and
status.id = 1 and
livros.id = marcacao_livros.id_livro and
marcacao_livros.id_status = status.id  and
usuarios.id = marcacao_livros.id_usuario;


-- deleta o livro
delete from livros where livros.id = 1;

-- deleta o livro da marcação
delete from marcacao_livros where marcacao_livros.id_livro = 1;
